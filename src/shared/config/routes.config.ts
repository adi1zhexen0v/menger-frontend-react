...
export const routes: IAppRoute[] = [
  ...
  {
    path: DASHBOARD_MANAGE_SENTENCE_TASK_PAGE_ROUTE,
    element: DashboardManageSentenceTaskPage,
    authOnly: true
  },
  {
    path: DASHBOARD_THEORY_PAGE_ROUTE,
    element: DashboardTheoryPage,
    authOnly: true
  },
  {
    path: DASHBOARD_WORD_TASK_PAGE_ROUTE,
    element: DashboardWordTaskPage,
    authOnly: true
  },
  {
    path: DASHBOARD_SENTENCE_TASK_PAGE_ROUTE,
    element: DashboardSentenceTaskPage,
    authOnly: true
  },
  {
    path: "*",
